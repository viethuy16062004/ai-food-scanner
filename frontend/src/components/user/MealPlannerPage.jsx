      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-10">
        ...
        <div className="lg:col-span-4 bg-white rounded-3xl p-6 border border-slate-100 shadow-sm">
          ...
          <button
            ...
            className="w-full inline-flex items-center justify-center gap-2 bg-[#047857] hover:bg-[#065f46] text-white text-xs font-extrabold py-2.5 rounded-2xl transition-all hover:shadow-sm"
          >
      ...
      <div className="mb-10">
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 text-xs font-extrabold text-[#047857] hover:text-[#065f46] hover:underline bg-emerald-50 px-3 py-2 rounded-2xl transition-colors border border-emerald-100"
          >
              ...
              <div className="p-5">
                ...
                <div className="flex border-t border-slate-50 pt-3">
                  <button
                    ...
                    className="w-full inline-flex items-center justify-center gap-1 text-[11px] font-extrabold text-emerald-800 hover:text-emerald-950 transition-all hover:bg-slate-50 py-1.5 rounded-xl border border-slate-100"
                  >
        ...
        <div className="lg:col-span-8 bg-white rounded-3xl p-6 border border-slate-100 shadow-sm">
          ...
          <form onSubmit={handleAddIngredient} className="flex gap-2">
            <input
              ...
              className="flex-1 bg-slate-50 border border-slate-100 focus:border-emerald-300 outline-none text-xs font-semibold px-4 py-3 rounded-2xl"
            />
            <select
              value={newCategory}
              onChange={(e) => setNewCategory(e.target.value)}
              className="bg-slate-50 border border-slate-100 text-xs font-bold px-3 py-3 rounded-2xl outline-none"
            >
            ...
            <button
              type="submit"
              className="bg-[#047857] hover:bg-[#065f46] text-white p-3 rounded-2xl transition-all shadow-sm flex items-center justify-center shrink-0"
            >
