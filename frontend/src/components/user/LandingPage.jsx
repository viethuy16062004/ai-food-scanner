...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-800 flex flex-col font-sans overflow-x-hidden selection:bg-emerald-500 selection:text-white">
      ...
      <div className="absolute top-1/3 right-1/4 w-[600px] h-[600px] bg-teal-500/5 rounded-full blur-[150px] pointer-events-none"></div>
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button 
              ...
              className="text-sm font-bold text-slate-600 hover:text-slate-900 px-4 py-2.5 rounded-xl hover:bg-slate-100 transition-all focus:outline-none"
            >
              Đăng nhập
            </button>
            <button 
      ...
      <section className="relative pt-20 pb-16 px-6 max-w-7xl mx-auto text-center flex flex-col items-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-50 text-emerald-600 border border-emerald-100 text-xs font-bold uppercase tracking-wider mb-6">
        ...
        <p className="text-slate-600 text-base sm:text-lg max-w-2xl mt-6 leading-relaxed font-medium">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 mt-10">
          ...
          <a 
            href="#features"
            className="w-full sm:w-auto text-slate-600 hover:text-slate-950 font-bold text-sm border border-slate-200 hover:border-slate-300 bg-white px-8 py-4 rounded-2xl transition-all hover:bg-slate-50 focus:outline-none text-center"
          >
            Khám phá tính năng
          </a>
        </div>
        ...
        <div className="mt-16 w-full max-w-5xl rounded-3xl border border-slate-100 bg-white/60 p-3 sm:p-4 backdrop-blur-md shadow-xl relative">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-emerald-500/10 to-teal-500/10 rounded-3xl blur opacity-30 pointer-events-none"></div>
          <div className="rounded-2xl border border-slate-100 overflow-hidden bg-slate-50 aspect-video flex items-center justify-center relative">
            <div className="absolute inset-0 bg-gradient-to-br from-emerald-50/10 to-slate-100/50 flex flex-col items-center justify-center p-6 text-center">
              <span className="text-6xl mb-4 animate-bounce">🍎</span>
              <h3 className="text-xl sm:text-2xl font-black text-slate-900">Hãy quét bất kỳ nhãn hoặc món ăn nào</h3>
              <p className="text-slate-600 text-xs sm:text-sm mt-2 max-w-md font-semibold">
                AI sẽ trích xuất chi tiết lượng Calo, tinh bột, chất đạm, chất béo và đưa ra lời khuyên dinh dưỡng ngay lập tức.
              </p>
              <div className="mt-6 flex gap-3 flex-wrap justify-center">
                <span className="bg-white text-xs font-bold px-3.5 py-2 rounded-xl border border-slate-200 text-emerald-600 flex items-center gap-1.5 shadow-sm">
                  <Camera className="w-4 h-4" /> Food Vision
                </span>
                <span className="bg-white text-xs font-bold px-3.5 py-2 rounded-xl border border-slate-200 text-teal-600 flex items-center gap-1.5 shadow-sm">
      ...
      <section id="features" className="py-24 px-6 max-w-7xl mx-auto border-t border-slate-100 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Card 1 */}
          <div className="p-6 bg-white border border-slate-100 rounded-3xl hover:border-emerald-500/30 transition-all hover:-translate-y-1 shadow-sm hover:shadow-lg hover:shadow-emerald-500/5 group">
            ...
            <h3 className="text-lg font-bold text-slate-800 mb-2">Food Vision AI</h3>
          ...
          <div className="p-6 bg-white border border-slate-100 rounded-3xl hover:border-emerald-500/30 transition-all hover:-translate-y-1 shadow-sm hover:shadow-lg hover:shadow-emerald-500/5 group">
            ...
            <h3 className="text-lg font-bold text-slate-800 mb-2">Đọc nhãn bao bì & Dị ứng</h3>
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed font-semibold">
          ...
          <div className="p-6 bg-white border border-slate-100 rounded-3xl hover:border-emerald-500/30 transition-all hover:-translate-y-1 shadow-sm hover:shadow-lg hover:shadow-emerald-500/5 group">
            ...
            <h3 className="text-lg font-bold text-slate-800 mb-2">Thực đơn khuyến nghị AI</h3>
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed font-semibold">
          ...
          <div className="p-6 bg-white border border-slate-100 rounded-3xl hover:border-emerald-500/30 transition-all hover:-translate-y-1 shadow-sm hover:shadow-lg hover:shadow-emerald-500/5 group">
            ...
            <h3 className="text-lg font-bold text-slate-800 mb-2">Nhật ký & Biểu đồ</h3>
            <p className="text-slate-600 text-xs sm:text-sm leading-relaxed font-semibold">
      ...
      <section className="py-20 px-6 bg-slate-50 border-t border-slate-100">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            ...
            <p className="text-slate-600 text-sm sm:text-base mt-6 leading-relaxed font-medium">
            ...
            <button 
              onClick={() => navigate("/login")}
              className="mt-8 flex items-center gap-2 text-emerald-600 font-bold hover:text-emerald-700 transition-colors"
            >
          ...
          <div className="lg:col-span-5 bg-white border border-slate-200/80 rounded-3xl p-5 shadow-xl relative">
            <div className="flex items-center gap-3 border-b border-slate-100 pb-3 mb-4">
              <div className="w-8 h-8 rounded-full bg-emerald-50 flex items-center justify-center text-emerald-600">
                🤖
              </div>
              <div>
                <h4 className="text-xs font-extrabold text-slate-800">AI Coach Dinh Dưỡng</h4>
                <p className="text-[10px] text-emerald-600 font-bold">Online</p>
              </div>
            </div>
            <div className="flex flex-col gap-3 max-h-[220px] overflow-y-auto">
              <div className="bg-slate-100 text-slate-700 text-xs p-3 rounded-2xl self-end max-w-[85%] font-medium">
                Tôi nên ăn gì sau buổi tập để cơ bắp phục hồi nhanh vậy Coach?
              </div>
              <div className="bg-emerald-50 border border-emerald-100/50 text-emerald-800 text-xs p-3 rounded-2xl self-start max-w-[85%] font-medium leading-relaxed">
      ...
      {/* CALL TO ACTION */}
      <section className="py-24 px-6 text-center max-w-7xl mx-auto border-t border-slate-100 relative">
        ...
        <p className="text-slate-600 text-sm sm:text-base mt-4 max-w-lg mx-auto font-medium">
      ...
      {/* FOOTER */}
      <footer className="bg-slate-50 border-t border-slate-100 py-8 px-6 text-center mt-auto">
